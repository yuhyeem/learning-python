...
#used .find to find index of w.e u enter
...
#used keywords to make code more legible to others and to make writing it easier in general
...
# used string methods to make a list much more readable, then wrote a for loop with .format to print each item from the new lists made in a print statement
...
for whitespace in highlighted_poems_list:
  highlighted_poems_stripped.append(whitespace.strip(" "))
...
for poem in range(0, len(highlighted_poems_details)):
  print("The poem {} was published by {} in {}".format(titles[poem], poets[poem], dates[poem]))
